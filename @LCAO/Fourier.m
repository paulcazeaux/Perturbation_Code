function result = Fourier(obj, R1, R2, K)
    % Normalizes the overlap of two orbitals with a Fourier phase term
    % exp^(-i K.x)
    ...
    for ind1 = 1:obj.size
        for ind2 = 1:obj.size
            ...
            result(ind1,ind2) = N*LCAO.fourier_aux(a1, b1, c1, alpha1, r1, a2, b2, c2, alpha2, r2, -K);
        end
    end
end